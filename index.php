 ...
 <header class="header fixed-top">
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-light">
         <!-- Brand -->
         <a class="navbar-brand" href="#"><img src="img/logo1.png" id="logo" alt="Que Sonho bom"></a>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar" >
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
               <a class="nav-link cadastro"  href="php/logout.php">Logout</a>
             </li>
         </ul>
       </div>
      </nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="home-content">
                   ...
                   <a href="php/cadastro.php" class="btn mybtn1">Saiba mais</a>
                </div>
            </div>
